(function(){
  angular
    .module('buy')
    .controller('buyphoneController',buyphoneController)

    function buyphoneController($scope,$cookies,timeNow,$window, $state,$stateParams,service,serviceAlert,serviceConfirm){
      var vm = this;
